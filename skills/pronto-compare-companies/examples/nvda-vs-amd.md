...
- Company A: **NVDA** (NVIDIA Corporation) — color `#3B82F6` (blue)
- Company B: **AMD** (Advanced Micro Devices) — color `#8B5CF6` (purple)
- Mode: Full Comparison (default)
- Period: Past Year
...
getStockPrices(companyId: 1001, fromDate: "2025-04-21", toDate: "2025-05-05", interval: "day") → NVDA Q1 reaction
getStockPrices(companyId: 1001, fromDate: "2025-07-24", toDate: "2025-08-07", interval: "day") → NVDA Q2 reaction
getStockPrices(companyId: 1001, fromDate: "2025-10-23", toDate: "2025-11-06", interval: "day") → NVDA Q3 reaction
getStockPrices(companyId: 1001, fromDate: "2026-01-22", toDate: "2026-02-05", interval: "day") → NVDA Q4 reaction
getStockPrices(companyId: 1002, fromDate: "2025-04-23", toDate: "2025-05-07", interval: "day") → AMD Q1 reaction
getStockPrices(companyId: 1002, fromDate: "2025-07-23", toDate: "2025-08-06", interval: "day") → AMD Q2 reaction
getStockPrices(companyId: 1002, fromDate: "2025-10-22", toDate: "2025-11-05", interval: "day") → AMD Q3 reaction
getStockPrices(companyId: 1002, fromDate: "2026-01-21", toDate: "2026-02-04", interval: "day") → AMD Q4 reaction
...
| | NVDA | AMD |
|--|------|-----|
| Sentiment Q1 | 0.52 | 0.41 |
| Sentiment Q2 | 0.58 | 0.38 |
| Sentiment Q3 | 0.61 | 0.43 |
| Sentiment Q4 | 0.67 | 0.39 |
| Sentiment Direction | RISING | FALLING |
| Investment Q1 | [raw from API] | [raw from API] |
| Investment Q2 | [raw from API] | [raw from API] |
| Investment Q3 | [raw from API] | [raw from API] |
| Investment Q4 | [raw from API] | [raw from API] |
| Investment Direction | RISING | FALLING |
| Stock Reaction Q1 | +4.2% | +1.8% |
| Stock Reaction Q2 | +6.1% | −2.3% |
| Stock Reaction Q3 | +8.3% | +0.9% |
| Stock Reaction Q4 | +5.7% | −1.4% |
...
## Step 5: Batch 4 — Quotes (both companies simultaneously)
...
search("AMD",    sentiment: "positive", speakerTypes: ["Executives"], topicSearchQuery: "growth outlook guidance", size: 3)
search("AMD",    sentiment: "negative", topicSearchQuery: "risk challenge headwind", size: 3)
search("AMD",    sections: ["EarningsCalls_Question"], size: 3)
```
...
**Shared topics (macro theme):** AI Accelerators — in both companies' top-3 lists

**Unique to NVDA:** Sovereign AI, Data Center (dominant position narrative)

**Unique to AMD:** PC Recovery, MI300 Ramp (execution story)

**Systemic risk:** Competition in AI accelerators affects both

**Idiosyncratic risk for AMD:** PC market softness — NVDA has no PC exposure

---

## Report Output (structure summary)

The report renders as inline HTML on claude.ai / written to `NVDA-vs-AMD-report.html` on Claude Cowork:

- **Header:** NVDA vs AMD — Comparison Report | Generated: Apr 6, 2026 | 2 Companies | Past Year
- **Section 1:** Scorecard — NVDA wins 9/9; winner cells green, AMD cells red (2-company rule)
- **Section 2:** Quarter card rows — NVDA (blue label), AMD (purple label); Charts 3 & 4 (multi-line sentiment + investment); callout: "📊 NVDA sentiment RISING (0.52→0.67), AMD FALLING (0.41→0.39)"
...
- **Section 5:** Chart 2 grouped bar — exec/analyst per company; gap table; Goldman Sachs most bullish firm for NVDA
- **Section 6:** Topics — AI Accelerators flagged as macro theme; PC Recovery as AMD-specific narrative
