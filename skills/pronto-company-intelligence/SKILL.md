...
description: "Use this skill any time the user mentions a specific company name or stock ticker — even with no other context. Examples: 'NVDA', 'Apple', 'analyze TSLA', 'how is Microsoft doing', 'give me a report on Google', 'what's the outlook for Amazon', 'deep dive on Meta', 'Tesla earnings', 'Netflix sentiment', 'should I buy Nvidia', 'what are the risks for Boeing', 'summarize JPMorgan for me', 'Goldman Sachs stock', 'is Apple a buy', 'what happened with Intel', 'show me MSFT', 'quick overview of Salesforce', 'how has Netflix been performing', 'what do analysts say about Disney', 'earnings call breakdown for Uber', 'stock performance of Visa', 'is the outlook bullish or bearish for [company]'. Trigger on any company research, analysis, investment, sentiment, earnings, stock, or financial question about a single named company. Do NOT trigger if the user asks to compare multiple companies against each other — that is a different skill. When in doubt — if the user names one company or ticker without a comparison intent — use this skill."
---
