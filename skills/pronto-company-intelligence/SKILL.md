...
description: Use this whenever a user asks about a company, stock, or wants to analyze, summarize, or research any public company. Produces company intelligence reports using ProntoNLP — covering quarter-over-quarter earnings sentiment, stock performance, analyst estimates, management tone, and competitive benchmarks. Trigger on phrases like "how is [company] doing", "analyze [ticker]", "give me a report on [company]", "what's the outlook for [stock]", "summarize [company] for me", "deep dive on [company]", "compare [company] to its competitors", "should I invest in [company]", "what are the risks for [company]", or any message mentioning a specific company name or ticker alongside analysis, investment, or research intent. When in doubt, trigger this skill — it handles both quick overviews and comprehensive deep dives.
---
