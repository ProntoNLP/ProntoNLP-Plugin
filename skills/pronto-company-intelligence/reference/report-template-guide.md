...
4. Quotes — `pronto-search-summarizer` ×4 (forecast) + positive + negative + analyst Q&A via Agent tool in parallel
...
4. Quotes — `pronto-search-summarizer` (negative) + `pronto-search-summarizer` (analyst negative questions) via Agent tool
