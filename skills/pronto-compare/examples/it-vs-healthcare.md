...
```
search("NVIDIA", sentiment: "positive", speakerTypes: ["Executives"],
  topicSearchQuery: "sector growth momentum AI infrastructure", size: 3)
  → "The infrastructure buildout for AI is just beginning..." — Jensen Huang, CEO, NVDA

search("NVIDIA", sentiment: "negative",
  topicSearchQuery: "sector risk challenge headwind", size: 3)
  → "Export restrictions create meaningful headwinds..." — Colette Kress, CFO, NVDA

search("Eli Lilly", sentiment: "positive", speakerTypes: ["Executives"],
  topicSearchQuery: "sector growth momentum GLP-1 obesity pipeline", size: 3)
  → "GLP-1 demand continues to outpace our manufacturing capacity..." — David Ricks, CEO, LLY

search("Eli Lilly", sentiment: "negative",
  topicSearchQuery: "pricing regulatory challenge headwind", size: 3)
